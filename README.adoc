image:https://github.com/interscript/maps/actions/workflows/test.yml/badge.svg["CI status", link="https://github.com/interscript/maps/actions/workflows/test.yml"]
